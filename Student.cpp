...
istream &operator >> (istream &in, Student &student){
    cout<<"nhap id: "; in>>student.id;
    cout<<"nhap ten: "; getline(in>>std::ws, student.name);
    cout<<"nhap lop: "; in>>student.className;
    cout<<"nhap khoa: "; in>>student.facultyName;
    cout<<"nhap gioi tinh: "; in>>student.sex;
    cout<<"nhap diem toan: "; in>>student.mathScore;
    cout<<"nhap diem anh: "; in>>student.englishScore;
    cout<<"nhap diem van: "; in>>student.literatureScore;
